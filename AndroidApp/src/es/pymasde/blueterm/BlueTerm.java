...
//    };
    ...
    public void left(View view) {
        view.startAnimation(AnimationUtils.loadAnimation(this, R.anim.anim_translate_left));
        byte[] b = {52};
        mSerialService.write(b);
    }

    public void right(View view) {
        view.startAnimation(AnimationUtils.loadAnimation(this, R.anim.anim_translate_right));
        byte[] b = {54};
        mSerialService.write(b);
    }
